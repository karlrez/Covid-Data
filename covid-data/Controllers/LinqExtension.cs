...
{
    /// <summary>
    /// Retrieved from: https://thecodegarden.net/dynamic-sort
    /// 
    /// Class to enable dynamic sorting, so a user can pass in orderby arguements
    /// which works like an SQL statement with multiple
    /// where clauses.
    /// 
    /// Example value for orderByStrValues param:
    /// ("date, prname DESC, numconf ASC") 
    /// </summary>
